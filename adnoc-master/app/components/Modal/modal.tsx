...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, lang }) => {
  ...
  const handleSubmit = () => {
    ...
    router.push("https://adnoc.speakup.report/en-GB/takallam/home");
  };
      ...
      <>
        {isOpen && (
          <div className="fixed inset-0 flex items-center justify-center z-50 font-custom">
            ...
            >
              <p
                className="text-gray-700 mb-4 md:text-base text-xs font-custom mt-7"
              ...
              <ol className="text-sm md:text-base" style={{ direction: "rtl" }}>
                ...
                {firstCheckboxError && (
                  <p className="text-red-500 text-xs mb-2 mr-2">
                    ...
                    <div>
                      <div className={`flex justify-end`}>
                        ...
                        >
                          <Link
                            href={`/NewPageDemo`}
                            style={{ marginLeft: "auto", direction: "rtl" }}
                          >
                            يتابع
                          </Link>
                        </button>
      ...
      <>
        {isOpen && (
          <div className="fixed inset-0 flex items-center justify-center z-50 font-custom">
            ...
            <div
              ref={modalRef}
              className="flex flex-col justify-center items-center bg-white p-6 my-6 rounded-lg z-50 w-full max-w-[90%] h-7/8 md:max-w-md md:w-[50%] overflow-y-auto"
              style={{ width: "100%", minWidth: "50%", maxHeight: "90vh" }}
            >
              <p
                  ...
                  <div>
                    <div className={`flex justify-start`}>
                      <button
                        onClick={handleSubmit}
                        className="mt-4 hover:bg-blue-600 text-white py-2 px-4 rounded-md"
                        style={{ backgroundColor: "#1947BA", direction: "rtl" }}
                      >
                        <Link
                          href={`/NewPageDemo`}
