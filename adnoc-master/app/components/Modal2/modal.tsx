...
const Modala: React.FC<ModalProps> = ({ isOpen, onClose, lang }) => {
  ...
  if (lang === "ar") {
                  ...
                  {isFirstChecked && isSecondChecked && (
                    <div>
                      <div className={`flex justify-end`}>
                        ...
                        >
                          <Link href={`/ar/viacall `}>يتابع</Link>
                        </button>
                      </div>
                      <div>
                        <p
    ...
    content = (
      <div className={`h-auto `}>
        {isOpen && (
          <div className="fixed inset-0 flex items-center justify-center z-50 font-custom h-auto px-2">
            <div className="absolute inset-0 bg-black opacity-50"></div>
            <div
              ref={modalRef}
              className="flex flex-col justify-center items-center bg-white py-6 px-4 my-6 rounded-lg z-50 w-full max-w-[90%] h-7/8 md:max-w-md md:w-[50%] overflow-y-auto"
